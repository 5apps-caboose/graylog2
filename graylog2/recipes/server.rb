...
# TODO configure cluster.name of elasticsearch
...
remote_file "download_server" do
  ...
  source "https://s3-eu-west-1.amazonaws.com/graylog2-releases/graylog2-server/graylog2-server-#{node.graylog2.server.version}.tar.gz"
  action :create_if_missing
end
